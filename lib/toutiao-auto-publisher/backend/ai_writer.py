...
from prompts import (
    ...
    SYSTEM_PROMPT_FENGHUO_QINGBAO,
    FENGHUO_QINGBAO_TOUTIE_PROMPT,
    MILITARY_RED_LINES,
    HUMANIZE_SYSTEM_PROMPT,
    HUMANIZE_USER_PROMPT,
    GLOBAL_ARCHIVE_HUMANIZE_SYSTEM_PROMPT,
    GLOBAL_ARCHIVE_HUMANIZE_USER_PROMPT,
    FENGHUO_QINGBAO_HUMANIZE_SYSTEM_PROMPT,
    FENGHUO_QINGBAO_HUMANIZE_USER_PROMPT,
    ARTICLE_PROMPT,
...
STYLE_ROUTER = {
    ...
    ContentStyle.FENGHUO_QINGBAO:   (SYSTEM_PROMPT_FENGHUO_QINGBAO,   FENGHUO_QINGBAO_TOUTIE_PROMPT,  0.7),
